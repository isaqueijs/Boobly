...
function getResult() {
	...
	document.getElementById('resultByPlugin_div').innerHTML = "NPRuntime : "
			+ (afterP.getTime() - beforeP.getTime()) + "ms";

	// document.getElementById('array1').innerHTML = "matA :<br>" + matA +
	// "<br>";
	// document.getElementById('array2').innerHTML = "matB :<br>" + matB +
	// "<br>";
	// document.getElementById('array3').innerHTML = "matResult JS :<br>" +
	// matResult + "<br>";
	// document.getElementById('array4').innerHTML = "matResult Plugin :<br>" +
	// NPRuntimeMatrix.getMatrixResult() + "<br>";
