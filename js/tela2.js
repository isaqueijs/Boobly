...
window.onload = function() {
    ...
    document.addEventListener('keydown', function(e) {
    	switch(e.keyCode){
    	case 37: alert("TETANDO IR PRA ONDE??") //LEFT arrow
    		break;
    	case 38: alert("TU NÃO VAI PRA CIMA!") //UP arrow
    		break;
    	case 39: alert("DIREITA????") //RIGHT arrow
    		break;
    	case 40: alert("VAI PRA BAIXO???") //DOWN arrow
    		break;
    	case 13: alert("TEM CERTEZA???") //OK button
    		break;
